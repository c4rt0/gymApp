...
const helpers = require("../utils/analytics");
const BMI = require("../utils/BMI");
const BMI_category = require("../utils/bmi_category");
const dashboard = {
  index(request, response) {
    ...
    const bmi = BMI.calculateBMI(latestWeight, user);
    const bmi_category =  BMI_category.getBMICategory(bmi);
